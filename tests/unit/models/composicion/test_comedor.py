...
class TestComedorComposicion:
    ...
    def test_comedor_diferente_numero_sillas(self):
        ...
        assert comedor.calcular_precio_total() > 150.0  # Al menos el precio base de la mesa
    ...
    def test_diferentes_configuraciones(self, num_sillas, precio_silla):
        ...
        assert comedor.calcular_precio_total() > 200.0  # Al menos el precio base de la mesa
