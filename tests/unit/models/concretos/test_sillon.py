...
class TestSillon:
    ...
    def test_sillon_reclinable(self):
        ...
        sillon = Sillon(
            "Sillón Comfort", "Tela", "Gris", 300, 2, True, "Tela", True, True, False
        )
    ...
    def test_sillon_no_reclinable(self):
        ...
        sillon = Sillon(
            "Sillón Básico", "Tela", "Azul", 250, 2, True, "Tela", True, False, False
        )
    ...
    def test_sillon_con_reposapiés(self):
        ...
        sillon = Sillon(
            "Sillón Relax", "Cuero", "Negro", 400, 1, True, "Cuero", True, True, True
        )
